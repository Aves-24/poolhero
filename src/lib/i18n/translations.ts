...
const pl: Dict = {
  ...
  // AI / share prompt
  "prompt.intro": "Jesteś ekspertem od domowych basenów. Mój basen ma {{volume}} litrów wody.",
  ...
  "prompt.closing": "Sprawdź w swojej bazie wiedzy czy jest coś do poprawy. Jeśli tak, zaproponuj konkretne rozwiązanie (jakie preparaty dodać i w jakiej przybliżonej ilości na {{volume}} litrów). Odpowiedz po polsku, zwięźle i praktycznie.",
  "prompt.closingWithWeather": "Sprawdź w swojej bazie wiedzy czy jest coś do poprawy. Jeśli tak, zaproponuj konkretne rozwiązanie (jakie preparaty dodać i w jakiej przybliżonej ilości na {{volume}} litrów). Uwzględnij dane techniczne basenu oraz warunki pogodowe przy dawkowaniu i rekomendacjach (np. wysokie temperatury i intensywne nasłonecznienie przyspieszają rozkład chloru, intensywne opady mogą rozcieńczyć wodę). Odpowiedz po polsku, zwięźle i praktycznie.",
...
const de: Dict = {
  ...
  "prompt.intro": "Sie sind ein Experte für private Pools. Mein Pool hat {{volume}} Liter Wasser.",
  ...
  "prompt.closing": "Prüfen Sie anhand Ihres Wissens, ob etwas verbessert werden sollte. Falls ja, schlagen Sie eine konkrete Lösung vor (welche Präparate in welcher ungefähren Menge für {{volume}} Liter). Antworten Sie auf Deutsch, prägnant und praktisch.",
  "prompt.closingWithWeather": "Prüfen Sie anhand Ihres Wissens, ob etwas verbessert werden sollte. Falls ja, schlagen Sie eine konkrete Lösung vor (welche Präparate in welcher ungefähren Menge für {{volume}} Liter). Berücksichtigen Sie die technischen Pooldaten sowie die Wetterbedingungen bei Dosierung und Empfehlungen (z. B. beschleunigen hohe Temperaturen und starke Sonneneinstrahlung den Chlorabbau, starker Regen kann das Wasser verdünnen). Antworten Sie auf Deutsch, prägnant und praktisch.",
